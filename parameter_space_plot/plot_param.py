...
base_colors[2] = '#990000'#'#9c0945'#base_colors[1]
base_colors[1] = white
base_colors[0] = '#ff9933'
...
shaded_cmap[:, 1] += 0.3
#shaded_cmap[:, 0] += 0.3
shaded_cmap[1, :] = np.array([0.0, 0.8, 0.8, 1])
print(shaded_cmap)
...
alpha_bound = np.sqrt(3) * 2.186**(1.5) / np.linspace(0.1, 500, 1000)
axs[1].plot(np.linspace(0.1, 500, 1000), alpha_bound, c='k')
