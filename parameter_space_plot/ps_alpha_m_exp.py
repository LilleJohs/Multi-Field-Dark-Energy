...
m_range = np.linspace(0, 180, length)
print(m_range)
colors = ['red', 'blue']
...
axs[0].set_ylabel(r'$\beta \; [M_{Pl}^{-1}]$')
...
axs[0].fill_between(m_range, meff_over_beta, color='blue', alpha=0.4)
print(meff_over_beta)
...
axs[1].set_ylabel(r'$\alpha \; [M_{Pl}^{-1}]$')
...
axs[1].fill_between(m_range, meff_over_alpha, color='blue', alpha=0.4)
plt.show()