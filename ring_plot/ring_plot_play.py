...
for i, r_init in enumerate(r_init_ranges):
    ...
    c = MultiFieldDarkEnergy(metric='r_p', potential='exp_spinning', params=params, N_min = 0, N_max = 50, gamma=1)
...
plt.polar(theta/2000, req, label=r'$r_{eq}$', c='k', linestyle='dashed', linewidth=3)
plt.legend()
plt.grid(True)
plt.box(on=None)
plt.xticks([])
